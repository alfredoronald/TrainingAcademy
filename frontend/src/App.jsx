...
function App() {
  ...
  const renderScreen = () => {
    ...
    switch (currentScreen) {
      ...
      case "catalog":
        return <CourseCatalogScreen role={selectedRole} {...commonProps} />;

      case "my-courses":
        return <MyCoursesScreen {...commonProps} />;

      case "leaderboard":
        return <LeaderboardScreen {...commonProps} />;

      case "badges":
        return <BadgesScreen {...commonProps} />;
      ...
      case "teacher-dashboard":
        return <TeacherDashboardView {...commonProps} />;

      case "teacher-profile":
        return <TeacherProfile {...commonProps} />;
      ...
      case "course-detail":
        return (
          <CourseDetail courseId={navigationParams.courseId} {...commonProps} />
        );
  ...
  return (
    <ErrorBoundary>
      <AuthProvider>
        <div className="min-h-screen bg-gray-100">{renderScreen()}</div>
      </AuthProvider>
    </ErrorBoundary>
  );
}
